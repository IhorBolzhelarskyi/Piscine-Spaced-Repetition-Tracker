...
function formatDate(dateStr) {
  // Format date in a friendly, accessible format (e.g. July 26, 2025)
  const date = new Date(dateStr + "T00:00:00Z"); // UTC to avoid DST issues
...
function displayAgenda(agenda) {
  ...
  // Filter out past revision dates (only show today or future)
